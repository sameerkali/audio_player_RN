...
export const fetchPlayListData = async () => {
  ...
  try {
    ...
    if (data && data.message === 'All mantras fetched successfully.') {
      ...
      // Assign fetched data to playListData
      playListData.push(...fetchedData);
      console.log(playListData, "============== data is not fatching ============")
